...
Call log:
  - waiting for locator('//iframe[@title=\'reCAPTCHA\']').contentFrame().locator('//div[@class=\'recaptcha-checkbox-checkmark\']')
    ...
    - generic [ref=e70]:
      - generic [ref=e71]:
        ...
        - paragraph [ref=e73]:
          ...
          - strong [ref=e74]: playground_4bbichqe@yopmail.com
...
```ts
  ...
  78 |     const iFrame = await this.page.frameLocator("//iframe[@title='reCAPTCHA']")
> 79 |     await iFrame.locator("//div[@class='recaptcha-checkbox-checkmark']").click();
     |                                                                          ^ Error: locator.click: Target page, context or browser has been closed
  80 |   });
  81 | }
  82 | }
